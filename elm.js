...
var _user$project$Main$hasNoChangesToSave = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$core$Native_Utils.eq(_p1._0, _p1._1);
};
var _user$project$Main$extractBlogText = function (_p2) {
	var _p3 = _p2;
	return _p3._0;
};
var _user$project$Main$readLastSavedBlogText = function (_p4) {
	var _p5 = _p4;
	return _user$project$Main$extractBlogText(_p5._0);
};
var _user$project$Main$readNewBlogText = function (_p6) {
	var _p7 = _p6;
	return _user$project$Main$extractBlogText(_p7._1);
};
var _user$project$Main$lastSavedBlog = function (_p8) {
	var _p9 = _p8;
	return _p9._0;
};
var _user$project$Main$currentBlog = function (_p10) {
	var _p11 = _p10;
	return _p11._1;
};
...
var _user$project$Main$MaybeSaved = F2(
	function (a, b) {
		return {ctor: 'MaybeSaved', _0: a, _1: b};
	});
var _user$project$Main$buildUpdatedBlog = F2(
	function (newBlog, _p12) {
		var _p13 = _p12;
		return A2(_user$project$Main$MaybeSaved, _p13._0, newBlog);
	});
var _user$project$Main$setSaved = F2(
	function (savedBlobText, _p14) {
		var _p15 = _p14;
		return A2(_user$project$Main$MaybeSaved, savedBlobText, _p15._1);
	});
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p16 = msg;
		if (_p16.ctor === 'MakeChange') {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						blog: A2(_user$project$Main$buildUpdatedBlog, _p16._0, model.blog)
					}),
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					...
					{
						blog: A2(
							_user$project$Main$setSaved,
							_user$project$Main$currentBlog(model.blog),
							model.blog)
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
...
var _user$project$Main$MakeChange = function (a) {
	return {ctor: 'MakeChange', _0: a};
};
				...
				_elm_lang$html$Html$textarea,
				{
					...
					_0: _elm_lang$html$Html_Events$onInput(
						function (newContents) {
							return _user$project$Main$MakeChange(
								_user$project$Main$Blog(newContents));
						}),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$value(
							_user$project$Main$readNewBlogText(model.blog)),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: _elm_lang$html$Html$text(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'Last Saved blog text : ',
										_user$project$Main$readLastSavedBlogText(model.blog))),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
									...
									_elm_lang$html$Html$button,
									{
										...
										_1: {
											...
											_0: _elm_lang$html$Html_Attributes$disabled(
												_user$project$Main$hasNoChangesToSave(model.blog)),
											_1: {ctor: '[]'}
										}
									},
									{
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"tags":{"Save":[],"MakeChange":["Main.Blog"]},"args":[]},"Main.Blog":{"tags":{"Blog":["String"]},"args":[]}}},"versions":{"elm":"0.18.0"}});
}
